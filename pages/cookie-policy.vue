<template>
  <div>
    ...
    <div v-html="sanitizeHtmlCustom(cookiePolicyMessage)" class="mt-2 custom-content-container"></div>
  </div>
</template>
...
const cookiePolicyMessage = computed(() => getStringConfigFieldByLocale("cookiePolicy", i18n.locale.value, serverConfigs));
