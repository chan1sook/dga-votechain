<template>
  <div>
    ...
    >
      ยืนยันการแก้ไขคำถามการลงคะแนนนี้?
    </DgaModal>
...
if (!data.value) {
  ...
  topicData.value.showVotersScore = topic.showVotersScore;
  topicData.value.voterAllows = topic.voterAllows;
