      ...
      <div class="border-2 border-gray-200 rounded-lg shadow p-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-7xl mx-auto my-4">
          ...
          <div class="md:col-span-2 my-2 text-center">
            <button type="button" class="dga-evote-btn w-full max-w-sm inline-flex gap-2 items-center justify-center" title="Edit Topic" :disabled="!isFormValid" @click="editTopic">
...
const topicData = ref<TopicFormEditData>({
  name: "",
  status: "pending",
  description: "",
