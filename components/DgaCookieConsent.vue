<template>
  <div
    class="fixed bottom-4 right-4 max-w-xl rounded-lg bg-white px-4 py-2 shadow-md"
  >
    <div class="flex flex-col items-center gap-4">
      ...
      <div
        class="mx-auto flex w-full flex-col gap-2 text-sm sm:w-auto sm:flex-row"
      >
