    ...
    <div class="dga-footer-about">
      ...
      <div class="flex-1 grid grid-cols-12 gap-x-2 gap-y-1">
        <div class="col-span-12 lg:col-span-7">
          <div :class="[ i18n.locale.value !== 'th' ? 'hidden lg:block': '']">สำนักงานพัฒนารัฐบาลดิจิทัล (องค์การมหาชน) (สพร.)</div>
          <div :class="[ i18n.locale.value !== 'en' ? 'hidden lg:block': '']">Digital Government Development Agency (Public Organization) (DGA)</div>
