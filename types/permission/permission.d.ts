...
type EVotePermissionUnused =
  | "request-topic"
  | "change-permissions:basic"
  | "change-permissions:advance";
type EVotePermission =
  | EVotePermissionBasic
  | EVotePermissionVoter
  | EVotePermissionAdmin
  | EVotePermissionDeveloper
  | EVotePermissionUnused;
